...
import static de.grobox.liberario.utils.Constants.LOCATION;

@ParametersAreNonnullByDefault
public class TripsLoader extends AsyncTaskLoader<QueryTripsResult> {
	...
	public TripsLoader(Context context, TransportNetworkManager manager, Location from, @Nullable Location via, Location to, Date date, boolean departure) {
		super(context);
