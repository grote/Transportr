...
public class LegPopupMenu extends BasePopupMenu {
	...
	public LegPopupMenu(Context context, View anchor, Stop stop) {
		...
		this.text = DateUtils.getTime(context, stop.getArrivalTime()) + " " + TransportrUtils.getLocationName(stop.location);
		this.getMenuInflater().inflate(R.menu.location_actions, getMenu());
			...
			public boolean onMenuItemClick(MenuItem item) {
				...
				switch(item.getItemId()) {
					...
					case R.id.action_from_here:
						TransportrUtils.presetDirections(context, 0, new WrapLocation(loc1), null, null);

						return true;
					// To Here
					case R.id.action_to_here:
						TransportrUtils.presetDirections(context, 0, null, null, new WrapLocation(loc1));
					...
					case R.id.action_share:
						Intent sendIntent = new Intent()
								                    ...
								                    .putExtra(Intent.EXTRA_SUBJECT, TransportrUtils.getLocationName(loc1))
					...
					case R.id.action_copy:
						TransportrUtils.copyToClipboard(context, TransportrUtils.getLocationName(loc1));
